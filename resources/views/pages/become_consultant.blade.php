            ...
            <div class="form-box">
                <form id="consultant-form" method="POST" action="{{ url('/api/become-consultant') }}">
                    ...
                    <div class="step">
                        ...
                        <div class="group-box">
                            <div class="form-group">
                                <input type="text" class="form-control" id="phone" name="phone" placeholder="{{ __('forms.phone') }}" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="group-box">
                            <div class="form-group mr-0">
                                ...
                                <select class="crs-country form-control" id="from" name="from" data-region-id="hidden-region" data-default-option="{{ __('forms.select-country') }}" required></select>
                        ...
                        <div class="group-box">
                            <div class="form-group">
                                ...
                                <select class="crs-country form-control" id="country" name="country" data-region-id="region" data-default-option="{{ __('forms.select-country') }}" required></select>
                            </div>
                            <div class="form-group">
                                <label for="region" class="labelfocus">@lang('forms.choose')</label>
                                <select id="region" name="region" class="form-control" data-blank-option="{{ __('forms.select-region') }}" data-default-option="{{ __('forms.select-region') }}" required></select>
                            </div>
                        </div>
                        <div class="group-box">
                            <div class="form-group">
                    ...
                    <div class="step">
                        ...
                        <div class="group-box">
                            <div class="form-group">
                                ...
                                <span class="img-outline btn-date-picker"><img src="{{ asset('images/calendar.svg') }}" /></span>
                            ...
                            <div class="form-group">
                                ...
                                <select id="gender" name="gender" class="form-control" required>
                                    <option value="male">@lang('forms.male')</option>
                                    <option value="female">@lang('forms.female')</option>
                                </select>
                            </div>
                        </div>
                        <div class="group-box">
                    ...
                    <div class="step">
                        ...
                        <div class="group-box three">
                            <div class="form-group">
                                ...
                                <select class="crs-country form-control" id="company_from" name="company_from" data-region-id="company_region" data-default-option="{{ __('forms.select-country') }}" required></select>
                            </div>
                            <div class="form-group">
                                <label for="company_region" class="labelfocus">@lang('forms.choose')</label>
                                <select id="company_region" name="company_region" class="form-control"  data-blank-option="{{ __('forms.select-region') }}" data-default-option="{{ __('forms.select-region') }}" required></select>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="group-box">
                            <div class="form-group mr-0">
                                ...
                                <select class="form-control" id="profession" name="profession" required>
                                    ...
                                    <?php $category_name = $lang == 'en' ? $category->category_name : $category->category_name_no; ?>
                                    <option value="{{$category->category_name}}">{{$category_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center custom-checkbox mb-3">
                                <label>
                                    <input type="checkbox" value="" id="educated">@lang('forms.educated')<span class="checkmark" id="educated"></span>
                                </label>
                            </div>
                            <div class="back-item education">
                                <p class="title">@lang('forms.consultant-edu')</p>
                                <div class="list" id="education-list"></div>
                                <div class="underline-bar"></div>
                                <a id="btn-education">+@lang('forms.add-education')</a>
                            </div>
                            <div class="back-item experience">
                                <p class="title">@lang('forms.consultant-work')</p>
                                <div class="list" id="experience-list"></div>
                                <div class="underline-bar"></div>
                                <a id="btn-work">+@lang('forms.add-experience')</a>
                            </div>
                            <div class="back-item certificate">
                                <p class="title">@lang('forms.consultant-certificates')</p>
                                <div class="list" id="certificate-list"></div>
                                <div class="underline-bar"></div>
                                <a id="btn-certificate">+@lang('forms.add-certificate')</a>
                            </div>
                        </div>
                    </div>
                    <div class="step">
                            ...
                            <form method="POST" action="{{ url('/add-experience') }}" id="experience-form">
                                ...
                                <div class="group-box">
                                    <div class="form-group">
                                        ...
                                        <select name="experience_country" class="crs-country form-control" id="experience_country" data-region-id="experience_city" data-default-option="{{ __('forms.select-country') }}" required></select>
                                    </div>
                                    <div class="form-group">
...
<script>
    ...
    $(document).ready(function(){
        // file upload
        $(".upload-profile-photo").on('click', function () {
        ...
        $(".upload-profile-education").on('click', function () {
            ...
            if (filesize < 2) {
                ...
                $.ajax({
                    ...
                    success: function (e) {
                        ...
                        $(ctx).parent().children("p.uploaded_file_name").append(ctx.files[0].name);
                    }
                });
            } else {
        ...
        $(".upload-profile-certificate").on('click', function () {
        ...
        $("#photo-confirmation").on('click', function () {
            if ($(this).prop("checked")) {
        ...
        $("#education-save").on('click', function (event) {
        ...
        $("#experience-save").on('click', function (event) {
            event.preventDefault();
        ...
        $("#certificate-save").on('click', function (event) {
            event.preventDefault();
        ...
        $("#educated").on('change', function (e) {
            if (!$(this).prop("checked")) {
                $(".step6 h5").attr("style", "color: #000;");
                $(".step6 .title").attr("style", "color: #000;");
            }
        });
        // form submit
        $(".btn-submit").on('click', function (event) {
            event.preventDefault();
            const educatedRequired = $("#educated").prop("checked");
            const wholeValidation = 
                educatedRequired ? 
                $("#consultant-form").valid() && $("#phone").intlTelInput("isValidNumber") &&
                consultant.docs.educations.length > 0 && consultant.docs.experiences.length > 0 && consultant.docs.certificates > 0
                : $("#consultant-form").valid() && $("#phone").intlTelInput("isValidNumber");
            if (wholeValidation) {
                $(".step6 h5").attr("style", "color: #000;");
                if ($("#terms").prop("checked") && $("#photo-confirmation").prop("checked")) {
                    ...
                    $("<input>").attr({ name: "gmt", type: "hidden", value: selected_timezone}).appendTo("#consultant-form");
                ...
                if (educatedRequired) {
                    ...
                    $(".step6 .title").attr("style", "color: #e71f1f;");
                }
            }
        });
