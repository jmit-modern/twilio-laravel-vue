        ...
        <div class="single-page">
            ...
            <div class="page-setting meta-info">
                <div class="admin page-seting-content">
                    ...
                    <textarea rows="5" cols="100" class="form-control" id="privacy_header_en_des">{{$page_body->header->en_des}}</textarea><br>
                    <label>Description (Norwegian)</label>
                    <textarea rows="5" cols="100" class="form-control" id="privacy_header_no_des">{{$page_body->header->no_des}}</textarea>
                    <button class="sp-f cs save-btn btn" id="privacy_header_save">@lang('admin.save')</button>
                </div>
            </div>
...
<script>
    ...
    editPrivacy(en_content, no_content);
</script>
@endsection