export default {
    en: {
        "about": {
            ...
            "find_consult": "Find a Consultant",
            "become_consult": "Become a Consultant",
        ...
        "member": {
            ...
            "session": "session",
            "sessions": "sessions",
            "no-consultants": "No consultant selected.",
            "no-customers": "No user selected.",
            "no-consultants-des": "Select a consultant you would like to chat, voice or video call with.",
            "no-customers-des": "Select a user you would like to chat, voice or video call with.",
            "no-customer-session": "You have no chat session with ",
            "no-customer-session-des": "Just wait for this customer create a session.",
            "no-session": "No sessions started yet.",
            "no-session-des": "Find a consultant based on your needs, and start chat, voice or video call.",
            "be-verb": "is",
            "selected-des": "Start a call or video conversation with",
            ...
            "incoming-video": "is video calling you.",
            "incoming-call": "is calling you.",
            "incoming-session": "Incoming session.",
            "incoming-session-des": "You have an incoming session from ",
            "progress-start": "Starting session.",
            "progress-start-des": "You are now starting a session with ",
            "session-end-modal": "End session?",
            "session-end-modal-des": "Are you sure you want to end session? Your balance will not be refunded.",
            "session-end-confirmation": "Are you sure you want to cancel this session?",
            "session-pause-modal": "Session is paused.",
            "session-pause-modal-des1": "The current session with ",
            "session-pause-modal-des2": "  is paused.",
            ...
            "start-session-dialog": "Start your session",
            "accept": "Accept",
            "decline": "Decline",
            "no-chat-history": "No chat history.",
            "no-chat-history-des1": "Write to",
            "no-chat-history-des2": "and start a conversation.",
    ...
    no: {
        ...
        "member": {
            ...
            "start-session-dialog": "Start økt",
            ...
            "no-customers": "Ingen brukere valgt.",
            "no-customers-des": "Velg en bruker du vil chatte, tale- eller videosamtale med.",
            "no-customer-session": "Du har ingen chat-økter med ",
            "no-customer-session-des": "Bare vent til denne kunden oppretter en økt.",
            "no-session": "Ingen økter startet ennå.",
            "no-session-des": "Finn en konsulent basert på dine behov, og start chat, tale eller videosamtale.",
            "be-verb": "er",
            "selected-des": "Start en samtale eller videosamtale med",
            ...
            "btn-continue-session": "Fortsett økt",
            "last-online": "sist på nettet",
            "session-end-alert": "Økten din avsluttes om 15 sekunder",
            "chat-end": "Chatten din er avsluttet",
            "rate-session": "Ranger denne økt",
            "continue": "Fortsette?",
            "continue-btn" : "Fortsette",
            "minutes-question": "Vil du fortsette økt?",
            "write-message": "Skriv melding her ....",
            "incoming-video": "er videosamtaler deg.",
            "incoming-call": "ringer deg.",
            "incoming-session": "Innkommende økt.",
            "incoming-session-des": "Du har en innkommende økt fra ",
            "progress-start": "Starter økt.",
            "progress-start-des": "Du starter nå en økt med ",
            "session-end-modal": "Avslutt økt?",
            "session-end-modal-des": "Er du sikker på at du vil avslutte økt? Saldoen din vil ikke bli refundert.",
            "session-end-confirmation": "Er du sikker på at du vil avbryte denne økt?",
            "session-pause-modal": "Økten er satt på pause.",
            "session-pause-modal-des1": "Den nåværende økt med ",
            "session-pause-modal-des2": " er satt på pause.",
            ...
            "continue-session": "Fortsett økt",
            "start-session": "Start økt",
            "accept": "Aksepterer",
            "decline": "Avslå",
            "no-chat-history": "Ingen chathistorie.",
            "no-chat-history-des1": "Skrive til",
            "no-chat-history-des2": "og starte en samtale.",
            "Psychologist": "Psykolog",
            "Economist": "Økonom",
            "Lawyer": "Advokat",
            "Doctor": "Lege",
            "Veterinarian": "Veterinærer",
            "Astrologer": "Astrolog",
            "Teacher": "Lærer",
            "Nurse": "Sykepleier",
            'today': 'I dag',
